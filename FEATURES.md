...
| 2.9f | Semáforo de canales: una tarjeta por canal agrupada por jugada, antes de la matriz | `ui/comercial._semaforo` | — | 🟡 — es la lectura para quien no lee matrices. La matriz sigue debajo, con burbujas NUMERADAS y leyenda al lado: los nombres reales de punto de venta montados sobre el gráfico no se leían. |
