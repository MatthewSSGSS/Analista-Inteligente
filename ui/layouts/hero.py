...
def hero(title: str, subtitle: str | None = None, icon: bool = False, tight: bool = False) -> None:
    ...
    if icon:
        ...
        st.markdown(f'<div class="hero"{style}><h1>{title}</h1>{subtitle_html}</div>', unsafe_allow_html=True)
